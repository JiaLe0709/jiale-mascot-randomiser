                ...
                <main className={"flex-4 md:p-8 p-6"}>
                    ...
                    <div className={"flex gap-2 text-[16px] mt-4 items-center text-center"} id={"tabs"}>
                        ...
                        <button
                            ...
                            className={`cursor-pointer ${tabs === "home" && "text-lime-300 underline font-mono font-semibold"}`}
                        >
                            Home
                        </button>
                        <button
                            ...
                            className={`cursor-pointer ${tabs === "gallery" && "text-lime-300 underline font-mono font-semibold"}`}
                        >
                            Gallery
                        </button>
                        <a
